    ...
    <main className="pt-32 lg:pt-40">
      ...
      <Container>
        ...
        <div className="mt-8 lg:flex lg:items-end lg:gap-16">
          <SplitLines
            as="h1"
            className="max-w-[16ch] font-display text-h1 uppercase leading-[0.94] text-foreground lg:shrink-0"
          >
            {page.h1}
          </SplitLines>
                ...
                {[
                  ...
                  <li key={s.n} className="flex gap-5">
                    ...
                    <span className="min-w-0">
                      <span className="block font-display text-h4 uppercase leading-tight text-foreground">
                        {s.t}
                      </span>
