          ...
          <div className="mt-16 lg:mt-24">
            {TECHNICAL.map((row, i) => (
              ...
              >
                ...
                <h3 className="mt-3 max-w-[22ch] font-display text-h3 uppercase leading-tight text-foreground transition-colors duration-slow ease-out-quart group-hover:text-accent lg:mt-0 lg:w-[40%] lg:shrink-0">
                  {row.t}
                </h3>
