    ...
    >
      ...
      <span
        ...
        className={cn(
          ...
          "font-display text-h4 uppercase leading-none tracking-tight text-foreground",
      ...
      >
        <span className="flex items-end justify-between gap-4">
          <span className="block whitespace-nowrap font-display text-h3 uppercase leading-none text-foreground">
            {industry.label}
          </span>
          <span
            aria-hidden
