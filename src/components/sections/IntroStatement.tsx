    ...
    <section ref={root} className="grain relative py-(--spacing-section)">
      <Container>
        ...
        <div className="mt-10 lg:flex lg:items-center lg:gap-16">
          <h2 className="max-w-[12ch] font-display text-h1 uppercase leading-[0.94] text-foreground lg:shrink-0">
            {introStatement}
          </h2>
          ...
          <ol className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            {introChain.map((link, i) => (
              ...
              >
                ...
                <span className="mt-5 block font-display text-h2 uppercase leading-none text-accent">
                  {link.verb}
                </span>
